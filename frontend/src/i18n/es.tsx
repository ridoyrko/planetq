const es = {
  ...
  entities: {
    musicTrack: {
        ...
        label: 'Music Tracks',
        menu: 'Music Tracks',
        exporterFileName: 'exportacion_musicTrack',
        list: {
          menu: 'Music Tracks',
          title: 'Music Tracks',
        },
        create: {
          success: 'Music Track guardado con éxito',
        },
        update: {
          success: 'Music Track guardado con éxito',
        },
        destroy: {
          success: 'Music Track eliminado con éxito',
        },
        destroyAll: {
          success: 'Music Track(s) eliminado con éxito',
        },
        edit: {
          title: 'Editar Music Track',
        },
        fields: {
          id: 'Id',
          'trackName': 'TrackName',
        ...
        placeholders: {
          'album': 'Album',
          'externalSourceUrl': 'Youtube or Sound Cloud Url',
        },
        hints: {
          'album': 'Music Album',
          'externalSourceUrl': 'Youtube (https://www.youtube.com/watch?v=AJtDXIazrMo), Soundcloud (https://soundcloud.com/andiecase/ellie-goulding-love-me-like-you-do-andie-case-cover)',
        },
        new: {
          title: 'Nuevo Music Track',
        },
        view: {
          title: 'Ver Music Track',
        },
        importer: {
          title: 'Importar Music Tracks',
          fileName: 'musicTrack_import_template',
          hint:
    ...
    regularSchedule: {
        ...
        menu: 'Regular Schedules',
        exporterFileName: 'exportacion_regularSchedule',
        list: {
          menu: 'Regular Schedules',
          title: 'Regular Schedules',
        },
        create: {
          success: 'Regular Schedule guardado con éxito',
        },
        update: {
          success: 'Regular Schedule guardado con éxito',
        },
        destroy: {
          success: 'Regular Schedule eliminado con éxito',
        },
        destroyAll: {
          success: 'Regular Schedule(s) eliminado con éxito',
        },
        edit: {
          title: 'Editar Regular Schedule',
        },
        fields: {
          id: 'Id',
          'day': 'Day',
          'musicTrack': 'Music Track(s)',
          createdAt: 'Creado el',
          updatedAt: 'Actualizado el',
          createdAtRange: 'Creado el',
        },
        ...
        new: {
          title: 'Nuevo Regular Schedule',
        },
        view: {
          title: 'Ver Regular Schedule',
        },
        importer: {
          title: 'Importar Regular Schedules',
          fileName: 'regularSchedule_import_template',
          hint:
            'Las columnas Archivos/Imágenes deben ser las URL de los archivos separados por espacio.',
        },
      },
    ...
    specialSchedule: {
        ...
        menu: 'Special Schedules',
        exporterFileName: 'exportacion_specialSchedule',
        list: {
          menu: 'Special Schedules',
          title: 'Special Schedules',
        },
        create: {
          success: 'Special Schedule guardado con éxito',
        },
        update: {
          success: 'Special Schedule guardado con éxito',
        },
        destroy: {
          success: 'Special Schedule eliminado con éxito',
        },
        destroyAll: {
          success: 'Special Schedule(s) eliminado con éxito',
        },
        edit: {
          title: 'Editar Special Schedule',
        },
        fields: {
          id: 'Id',
          'description': 'Description',
          'scheduleDateRange': 'Schedule Date',
        ...
        new: {
          title: 'Nuevo Special Schedule',
        },
        view: {
          title: 'Ver Special Schedule',
        },
        importer: {
          title: 'Importar Special Schedules',
          fileName: 'specialSchedule_import_template',
          hint:
            'Las columnas Archivos/Imágenes deben ser las URL de los archivos separados por espacio.',
        },
      },
