const ptBR = {
  ...
  entities: {
    musicTrack: {
        ...
        label: 'Music Tracks',
        menu: 'Music Tracks',
        exporterFileName: 'Music Track_exportados',
        list: {
          menu: 'Music Tracks',
          title: 'Music Tracks',
        },
        create: {
          success: 'Music Track salvo com sucesso',
        },
        update: {
          success: 'Music Track salvo com sucesso',
        },
        destroy: {
          success: 'Music Track deletado com sucesso',
        },
        destroyAll: {
          success: 'Music Track(s) deletado com sucesso',
        },
        edit: {
        ...
        new: {
          title: 'Novo Music Track',
        },
        view: {
          title: 'Visualizar Music Track',
        },
        importer: {
          title: 'Importar Music Tracks',
          fileName: 'musicTrack_template_importacao',
          hint:
    ...
    regularSchedule: {
        ...
        exporterFileName: 'Regular Schedule_exportados',
        list: {
          menu: 'Regular Schedules',
          title: 'Regular Schedules',
        },
        create: {
          success: 'Regular Schedule salvo com sucesso',
        },
        update: {
          success: 'Regular Schedule salvo com sucesso',
        },
        destroy: {
          success: 'Regular Schedule deletado com sucesso',
        },
        destroyAll: {
          success: 'Regular Schedule(s) deletado com sucesso',
        },
        edit: {
        ...
        new: {
          title: 'Novo Regular Schedule',
        },
        view: {
          title: 'Visualizar Regular Schedule',
        },
        importer: {
          title: 'Importar Regular Schedules',
          fileName: 'regularSchedule_template_importacao',
          hint:
            'Arquivos/Imagens devem ser as URLs dos arquivos, separados por espaço. Relacionamentos devem ser os IDs separados por espaço.',
        },
      },
    ...
    specialSchedule: {
        ...
        exporterFileName: 'Special Schedule_exportados',
        list: {
          menu: 'Special Schedules',
          title: 'Special Schedules',
        },
        create: {
          success: 'Special Schedule salvo com sucesso',
        },
        update: {
          success: 'Special Schedule salvo com sucesso',
        },
        destroy: {
          success: 'Special Schedule deletado com sucesso',
        },
        destroyAll: {
          success: 'Special Schedule(s) deletado com sucesso',
        },
        edit: {
        ...
        new: {
          title: 'Novo Special Schedule',
        },
        view: {
          title: 'Visualizar Special Schedule',
        },
        importer: {
          title: 'Importar Special Schedules',
          fileName: 'specialSchedule_template_importacao',
          hint:
            'Arquivos/Imagens devem ser as URLs dos arquivos, separados por espaço. Relacionamentos devem ser os IDs separados por espaço.',
        },
      },
